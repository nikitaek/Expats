...
if (!args.date_from || !args.date_to) {
  console.error(
    "Usage: v2:download-routes --data-kind actual --date-from YYYY-MM-DD --date-to YYYY-MM-DD [--routes A-B,C-D] [--force]\n" +
      "       v2:download-routes --data-kind upcoming [--routes A-B,C-D] [--limit N] [--force]",
  );
  process.exit(1);
}
